...
jsPsych.plugins["html-keyboard-response"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // outcome_data_random = [1,2,3].sample()
      ...
      var randomNumber = (Math.random() * outcome_array.length) | 0
      var actuallNumber = randomNumber + 1
      var rand = outcome_array[randomNumber]
      console.log(rand)
      ...
      var html = '';
        html += `
              <div class="info"> You earned ${rand} from trial ${actuallNumber}
                </div>`
